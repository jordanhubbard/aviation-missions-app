...
var i_10138 = (self__.level + (1));
while(true){
if((i_10138 <= (new_level + (1)))){
(update[i_10138] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_10141 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_10141[i]));
} else {
x__$2.forward.push((((i < links_10141.length))?(links_10141[i]):null));
}

if((i < links_10141.length)){
(links_10141[i] = x__$2);
} else {
links_10141.push(x__$2);
}
...
var i_10148 = (0);
while(true){
if((i_10148 <= self__.level)){
var links_10149 = (update[i_10148]).forward;
if((x__$1 === (((i_10148 < links_10149.length))?(links_10149[i_10148]):null))){
(links_10149[i_10148] = (x__$1.forward[i_10148]));

var G__10151 = (i_10148 + (1));
i_10148 = G__10151;
continue;
} else {
var G__10152 = (i_10148 + (1));
i_10148 = G__10152;
continue;
}
} else {
...
var G__10156 = nx;
var G__10157 = (level__$1 - (1));
x = G__10156;
level__$1 = G__10157;
continue;
} else {
var G__10158 = x;
var G__10159 = (level__$1 - (1));
x = G__10158;
level__$1 = G__10159;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__10165 = nx;
var G__10166 = (level__$1 - (1));
x = G__10165;
level__$1 = G__10166;
continue;
} else {
var G__10167 = x;
var G__10168 = (level__$1 - (1));
x = G__10167;
level__$1 = G__10168;
continue;
}
