...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_10573 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_10573(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_10574 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_10574(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_10575 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_10575(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_10577 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_10577(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_10579 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_10579(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_10583 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_10583(reader);
}
});
...
var G__10735 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__10736 = s.append(c);
c = G__10735;
s = G__10736;
continue;
}
