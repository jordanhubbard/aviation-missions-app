...
var G__10426 = o;
reagent.impl.template.goog$module$goog$object.set(G__10426,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__10795__i = 0, G__10795__a = new Array(arguments.length -  0);
while (G__10795__i < G__10795__a.length) {G__10795__a[G__10795__i] = arguments[G__10795__i + 0]; ++G__10795__i;}
  args = new cljs.core.IndexedSeq(G__10795__a,0,null);
} 
...
return G__10794__delegate(args);
});
...
var G__10437 = o;
reagent.impl.template.goog$module$goog$object.set(G__10437,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__10816__i < G__10816__a.length) {G__10816__a[G__10816__i] = arguments[G__10816__i + 0]; ++G__10816__i;}
  args = new cljs.core.IndexedSeq(G__10816__a,0,null);
} 
...
var G__10455 = props;
var G__10455__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10455,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10455);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10455__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__10493 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10493,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__10493;
}
})(),id_class);
...
var G__10501 = (cljs.core.count(argv) - first_child);
switch (G__10501) {
case (0):
...
var vec__10535 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10535,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10535,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10535,(2),null);
...
var temp__5808__auto___10898 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___10898 == null)){
} else {
var key_10904 = temp__5808__auto___10898;
(jsprops.key = key_10904);
}
...
var temp__5808__auto___10914 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___10914 == null)){
} else {
var key_10915 = temp__5808__auto___10914;
(jsprops.key = key_10915);
}
...
var temp__5808__auto___10931 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___10931 == null)){
} else {
var key_10932 = temp__5808__auto___10931;
(jsprops.key = key_10932);
}
...
var temp__5808__auto___10958 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___10958 == null)){
} else {
var key_10967 = temp__5808__auto___10958;
(jsprops.key = key_10967);
}
...
var temp__5808__auto___10972 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___10972 == null)){
} else {
var key_10982 = temp__5808__auto___10972;
(jsprops.key = key_10982);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10619_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__10619_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__10645 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10645,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10645,(1),null);
...
break;
default:
var G__11002 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__11003 = compiler;
v = G__11002;
compiler = G__11003;
continue;
...
var G__10669 = tag;
var G__10669__$1 = (((G__10669 instanceof cljs.core.Keyword))?G__10669.fqn:null);
switch (G__10669__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template10727 = (function (opts,id,fn_to_element,parse_fn,meta10729){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template10727.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_10730,meta10729__$1){
var self__ = this;
var _10730__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template10727(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta10729__$1));
}));

(reagent.impl.template.t_reagent$impl$template10727.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_10730){
var self__ = this;
var _10730__$1 = this;
return self__.meta10729;
}));

(reagent.impl.template.t_reagent$impl$template10727.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template10727.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template10727.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template10727.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template10727.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template10727.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta10729","meta10729",-139980367,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template10727.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template10727.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template10727");

(reagent.impl.template.t_reagent$impl$template10727.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template10727");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template10727.
 */
reagent.impl.template.__GT_t_reagent$impl$template10727 = (function reagent$impl$template$__GT_t_reagent$impl$template10727(opts,id,fn_to_element,parse_fn,meta10729){
return (new reagent.impl.template.t_reagent$impl$template10727(opts,id,fn_to_element,parse_fn,meta10729));
});
...
return (new reagent.impl.template.t_reagent$impl$template10727(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
